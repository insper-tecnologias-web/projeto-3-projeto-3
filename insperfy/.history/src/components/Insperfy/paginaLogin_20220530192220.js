        ...
        <Box sx={{ flexGrow: 1 }}>
            <Grid container spacing={0} sx={{ height: "100vh" }}>
                ...
                <Grid container item xs={12} sx={{ height: "70vh", backgroundColor: "var(--lighterBg)" }}>
                    ...
                    <Grid container item direction="column" align="center" xs={7} sx={{ height: "100%", padding:"2%", justifyContent:"center", gap:"1rem" }}>
                        ...
                        <Button variant="contained" sx={{backgroundColor:"var(--green)", fontSize:"1.8rem",width: "fit-content"}}>Login com Spotify</Button>
                    </Grid>
                </Grid>
